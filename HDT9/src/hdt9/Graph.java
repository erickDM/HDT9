...
Archivo basado en libreria jgrapht.org
 */
package hdt9;
...
//Clase base para creacion de grafos
public class Graph {
    ...
    //Obtener peso entre ciudades
    public double getPeso(String origen, String destino){
        if(origen.equals(destino)){
            return 0.0;
        }
        Aristas aux = new Aristas(new Vertice(origen),new Vertice(destino),9999.0);
    ...
    //Realizacion de algoritmo de floyd
